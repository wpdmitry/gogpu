...
|---------|------|-------------|
| **v0.44.4** | 2026-07-12 | **WriteSurfacePixels** — `ContextRenderTarget` implements `ggcanvas.SurfacePixelWriter`. Software backend zero-copy present (bypasses render pass pipeline). deps: wgpu v0.30.15, x/sys v0.47.0. ADR-050. |
